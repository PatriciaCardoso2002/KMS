...
public:
    ...
    void settxFileName(t_string txFileName){txFileName = txFileName;};
    t_string gettxFileName(){return txFileName;};

    void setrxFileName(t_string rxFileName){rxFileName = rxFileName;};
    t_string getrxFileName(){return rxFileName;};
